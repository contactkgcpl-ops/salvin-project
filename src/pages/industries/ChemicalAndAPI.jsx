  ...
  return (
    <div className="w-full bg-[#FAFAFA] font-sans">
      ...
      <section className="relative pt-40 pb-32 bg-[#0B1F35] overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/chemical-hero-bg.png')] bg-cover bg-center opacity-40 blur-[2px] scale-105"></div>
        <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Heavy-duty, high-containment chemical plant setups engineered for maximum safety, durability, and yield optimization.
            </p>
          </motion.div>
        </div>
      </section>
