...
/* ─── Process Flow Steps ─── */
const PROCESS_STEPS = [
  { id: 1, title: 'Receiving & Washing' },
  { id: 2, title: 'Crushing & Pulping' },
  { id: 3, title: 'Pre-Heating' },
  { id: 4, title: 'Vacuum Evaporation' },
  { id: 5, title: 'Paste Homogenization' },
  { id: 6, title: 'Thermal Processing' },
...
const FAQS = [
  {
    question: "What Brix level can this plant achieve?",
    answer: "Our multi-effect evaporation system can efficiently produce high concentration paste up to 28-30% or 36-38% Brix based on your configuration."
  },
  {
    question: "Is the process continuous?",
    answer: "Yes, this is a fully automated, continuous turnkey processing line designed for uninterrupted industrial scale production."
  },
  {
    question: "Does the process damage the natural color?",
    answer: "No. By using vacuum concentrators, the boiling point is significantly reduced, which prevents thermal degradation and preserves the deep red color."
  },
  {
  ...
  {
    question: "Why choose SALVIN for Tomato Paste Plants?",
...
export default function TomatoPasteDetailPage() {
  ...
  return (
    <div className="rcp-page">
      <SEO 
        title="Fully Automatic Tomato Paste Plant | Turnkey Solutions | Salvin"
        description="End-to-end turnkey Tomato Paste Processing Plant by Salvin Industries. Features multi-effect evaporation for premium high brix paste concentration."
      />
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__content">
          ...
          <p className="rcp-hero__subtitle">
            Fully Automated Process For High Brix Concentration & Maximum Output
          </p>
              ...
              <div className="rcp-overview__features">
                ...
                <div className="rcp-overview__feature">
                  ...
                  <div className="rcp-overview__feature-body">
                    <p className="rcp-overview__feature-title">High Brix Output</p>
                    <p className="rcp-overview__feature-desc">Multi-effect evaporation</p>
                  </div>
                </div>
                {/* Feature 2 */}
                <div className="rcp-overview__feature">
                ...
                <div className="rcp-overview__feature">
                  ...
                  <div className="rcp-overview__feature-body">
                    ...
                    <p className="rcp-overview__feature-desc">Homogenization for smooth texture</p>
                  </div>
                </div>
                {/* Feature 4 */}
                <div className="rcp-overview__feature">
                  ...
                  <div className="rcp-overview__feature-body">
                    ...
                    <p className="rcp-overview__feature-desc">Fully automatic continuous operation</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="rcp-section rcp-process-new" id="process-flow" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['process-flow'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw tomatoes into premium-quality packaged paste.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Tomato Paste Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="TomatoPasteDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Tomato Paste Plant?</h2>
            <p>
            ...
            <div className="rcp-cta__actions">
              <a
                href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Tomato%20Paste%20Plant.%20Please%20share%20details."
                target="_blank"
