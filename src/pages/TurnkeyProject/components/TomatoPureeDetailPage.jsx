  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/tomato-puree-plant.jpg')` }} />
        ...
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                Salvin Industries' Tomato Puree Processing Plant is an advanced, fully automated turnkey system designed to extract the highest yield and quality from raw tomatoes.
              </p>
              <p>
                The line integrates gentle washing, precise sorting, and high-efficiency crushing, followed by vacuum deaeration and evaporation. This ensures the puree retains its vibrant natural color, fresh aroma, and maximum nutritional value, securely sealed via our aseptic filling machines.
              </p>
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/turnkey-brochures/images/tomato-puree-plant.jpg" alt="Tomato Puree Processing Plant" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
