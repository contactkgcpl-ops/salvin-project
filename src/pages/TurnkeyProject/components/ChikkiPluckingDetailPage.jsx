...
export default function ChikkiPluckingDetailPage() {
  ...
  return (
    <div className="rcp-page">
      <SEO 
        title="Fully Automated Brittle (Chikki) Plucking Plant | Turnkey Solutions | Salvin Industries"
        description="Complete turnkey Brittle (Chikki) Plucking Plant by Salvin Industries. From sugar cooking to packaging — automated, food-grade processing line."
      />
