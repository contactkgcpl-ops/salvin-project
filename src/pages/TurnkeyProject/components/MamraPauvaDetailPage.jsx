...
/* ─── Process Flow Steps ─── */
const PROCESS_STEPS = [
  { id: 1, title: 'Raw Paddy Intake' },
  { id: 2, title: 'Steaming & Boiling' },
  { id: 3, title: 'Puffing (Mamra)' },
  { id: 4, title: 'Dehusking & Separation' },
  { id: 5, title: 'Size Grading' },
  { id: 6, title: 'Flavor Mixing' },
...
const MACHINERY_LIST = [
  {
    ...
    image: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_1.jpg',
    desc: 'Advanced pre-cleaning system to automatically remove stones, dust, and impurities from raw paddy/rice before processing.'
  },
  {
    name: 'Continuous Roasting & Puffing Oven',
    image: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_2.jpg',
    desc: 'High-efficiency automated oven designed for continuous and uniform roasting and puffing of grains.'
  },
  {
    name: 'Multi-Stage Cooling & Grading Conveyor',
    image: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_3.jpg',
    desc: 'Long conveyor system equipped with exhaust fans to rapidly cool and grade the puffed mamra/pauva.'
  },
  {
    name: 'Rotary Flavoring & Mixing Drum',
    image: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_4.jpg',
    desc: 'Hexagonal rotary drum for uniform application and blending of oil, salt, and spices on the finished product.'
  },
  {
    name: 'Transfer & Feed Conveyor System',
    image: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_5.jpg',
    desc: 'Hygienic inclined conveyor system to seamlessly transfer the processed mamra to the packaging line.'
  },
  {
    name: 'Automatic Multi-Head Packing Machine',
    image: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_6.jpg',
    desc: 'High-speed vertical form-fill-seal (VFFS) packing machine with multi-head weighers for accurate and fast pouch packing.'
  }
]
...
const FAQS = [
  {
    question: "Is this plant suitable for both Mamra and Pauva?",
    answer: "Yes, the process line can be customized or configured to handle both puffed rice (Mamra) and flattened rice (Pauva) processing."
  },
  {
    question: "Does the system include flavoring?",
    answer: "Yes, the plant includes an automated mixing and flavoring system to add seasonings uniformly before packing."
  },
  {
    question: "What is the material of construction?",
    answer: "All contact parts are made of high-quality food-grade stainless steel (SS304) ensuring maximum hygiene and safety."
  },
  {
  ...
  {
    question: "Why choose SALVIN for Mamra Pauva Plants?",
...
const GALLERY_IMAGES = [
  { src: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_1.jpg', caption: 'Automatic Destoning & Cleaning Machine' },
  { src: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_2.jpg', caption: 'Continuous Roasting & Puffing Oven' },
  { src: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_3.jpg', caption: 'Cooling & Grading Conveyor' },
  { src: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_4.jpg', caption: 'Rotary Flavoring & Mixing Drum' },
  { src: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_5.jpg', caption: 'Transfer & Feed Conveyor System' },
  { src: '/turnkey-brochures/images/mamra-pauva-gallery/mamra_pauva_6.jpg', caption: 'Automatic Multi-Head Packing Machine' }
]

/* ════════════════════════════════════════════════════════════════════
   MAIN COMPONENT
   ════════════════════════════════════════════════════════════════════ */
export default function MamraPauvaDetailPage() {
  ...
  return (
    <div className="rcp-page">
      <SEO 
        title="Fully Automated Mamra Pauva Processing Plant | Turnkey Solutions"
        description="End-to-end turnkey Mamra (Puffed Rice) and Pauva (Flattened Rice) Processing Plant by Salvin Industries. High efficiency & hygienic processing line."
      />
              ...
              <div className="rcp-overview__features">
                ...
                <div className="rcp-overview__feature">
                  ...
                  <div className="rcp-overview__feature-body">
                    ...
                    <p className="rcp-overview__feature-desc">Continuous, uninterrupted operation</p>
                  </div>
                </div>
                {/* Feature 2 */}
                <div className="rcp-overview__feature">
                  ...
                  <div className="rcp-overview__feature-body">
                    ...
                    <p className="rcp-overview__feature-desc">Food safety compliant construction</p>
                  </div>
                </div>
                {/* Feature 3 */}
                <div className="rcp-overview__feature">
                  ...
                  <div className="rcp-overview__feature-body">
                    <p className="rcp-overview__feature-title">Uniform Crispiness</p>
                    <p className="rcp-overview__feature-desc">Optimized steaming and puffing</p>
                  </div>
                </div>
                {/* Feature 4 */}
                <div className="rcp-overview__feature">
      ...
      <section className="rcp-section rcp-process-new" id="process-flow" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['process-flow'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw ingredients into premium-quality packaged products.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Mamra Pauva Processing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="MamraPauvaDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Mamra Pauva Plant?</h2>
            <p>
            ...
            <div className="rcp-cta__actions">
              <a
                href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Mamra%20Pauva%20Plant.%20Please%20share%20details."
                target="_blank"
